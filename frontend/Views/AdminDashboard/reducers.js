...
export const adminInfoReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case CREATE_FORUM_FAILURE:
      return Object.assign({}, state, {
        creatingForum: false,
        creatingForumError: 'An error occurred while trying to create the forum. Please try again.',
      });
    ...
    case DELETE_FORUM_FAILURE:
      return Object.assign({}, state, {
        deletingForum: false,
        deletingForumError: 'Something went wrong while trying to delete the forum. Please try again.',
      });
