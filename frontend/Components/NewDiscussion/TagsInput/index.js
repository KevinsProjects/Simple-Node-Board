  ...
  addTag() {
    ...
    if (this.validateTag(tagName)) {
      if (!this.sameTag(tagName)) {
        ...
        this.setState({ errorMsg: 'Tag already exists.' });
      }
    } else {
      this.setState({ errorMsg: ' 4-20 Characters minimum. Tags can only contain small letters and numbers. No space or special characters allowed.' });
    }
  }
